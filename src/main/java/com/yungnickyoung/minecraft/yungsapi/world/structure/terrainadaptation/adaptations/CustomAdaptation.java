...
public class CustomAdaptation extends EnhancedTerrainAdaptation {
    ...
    public static final MapCodec<CustomAdaptation> CODEC =
        RecordCodecBuilder.mapCodec(builder ->
            builder
                .group(
                    ExtraCodecs.NON_NEGATIVE_INT.fieldOf(
                        "kernel_size"
                    ).forGetter(EnhancedTerrainAdaptation::getKernelSize),
                    ExtraCodecs.NON_NEGATIVE_INT.fieldOf(
                        "kernel_distance"
                    ).forGetter(EnhancedTerrainAdaptation::getKernelDistance),
                    TerrainAction.CODEC.fieldOf("top").forGetter(
                        EnhancedTerrainAdaptation::topAction
                    ),
                    TerrainAction.CODEC.fieldOf("bottom").forGetter(
                        EnhancedTerrainAdaptation::bottomAction
                    ),
                    Codec.DOUBLE.optionalFieldOf(
                        "bottom_offset",
                        0.0
                    ).forGetter(EnhancedTerrainAdaptation::getBottomOffset),
                    EnhancedTerrainAdaptation.Padding.CODEC.optionalFieldOf(
                        "padding",
                        EnhancedTerrainAdaptation.Padding.ZERO
                    ).forGetter(EnhancedTerrainAdaptation::getPadding),
                    AquiferOverrideType.AQUIFER_OVERRIDE_CODEC.optionalFieldOf(
                        "aquifer_override",
                        AquiferOverride.NONE
                    ).forGetter(EnhancedTerrainAdaptation::getAquiferOverride)
                )
