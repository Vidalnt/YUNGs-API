...
public abstract class YungJigsawPoolElement extends StructurePoolElement {
    ...
    public boolean isAtValidDepth(int depth) {
        boolean isAtMinRequiredDepth =
            minRequiredDepth.isEmpty() || minRequiredDepth.get() <= depth;
        boolean isAtMaxAllowableDepth =
            maxPossibleDepth.isEmpty() || maxPossibleDepth.get() >= depth;
    ...
    public static <E extends YungJigsawPoolElement> RecordCodecBuilder<
        E,
        Optional<String>
    > nameCodec() {
        return Codec.STRING.optionalFieldOf("name").forGetter(
            YungJigsawPoolElement::getName
        );
    }
    ...
    public static <E extends YungJigsawPoolElement> RecordCodecBuilder<
        ...
        Optional<Integer>
    > maxCountCodec() {
        return ExtraCodecs.NON_NEGATIVE_INT.optionalFieldOf(
            "max_count"
        ).forGetter(YungJigsawPoolElement::getMaxCount);
    }
    ...
    > minRequiredDepthCodec() {
        return ExtraCodecs.NON_NEGATIVE_INT.optionalFieldOf(
            "min_required_depth"
        ).forGetter(YungJigsawPoolElement::getMinRequiredDepth);
    }
    ...
    > maxPossibleDepthCodec() {
        return ExtraCodecs.NON_NEGATIVE_INT.optionalFieldOf(
            "max_possible_depth"
        ).forGetter(YungJigsawPoolElement::getMaxPossibleDepth);
    }
    ...
    public static <E extends YungJigsawPoolElement> RecordCodecBuilder<
        ...
        Boolean
    > isPriorityCodec() {
        return Codec.BOOL.optionalFieldOf("is_priority", false).forGetter(
            YungJigsawPoolElement::isPriorityPiece
        );
    }
    ...
    public static <E extends YungJigsawPoolElement> RecordCodecBuilder<
        ...
        Boolean
    > ignoreBoundsCodec() {
        return Codec.BOOL.optionalFieldOf("ignore_bounds", false).forGetter(
            YungJigsawPoolElement::ignoresBounds
        );
    }
    ...
    public static <E extends YungJigsawPoolElement> RecordCodecBuilder<
        ...
        StructureCondition
    > conditionCodec() {
        return StructureConditionType.CONDITION_CODEC.optionalFieldOf(
            "condition",
            StructureCondition.ALWAYS_TRUE
        ).forGetter(YungJigsawPoolElement::getCondition);
    }

    public static <E extends YungJigsawPoolElement> RecordCodecBuilder<
        E,
        Optional<EnhancedTerrainAdaptation>
    > enhancedTerrainAdaptationCodec() {
        return EnhancedTerrainAdaptationType.ADAPTATION_CODEC.optionalFieldOf(
            "enhanced_terrain_adaptation"
        ).forGetter(YungJigsawPoolElement::getEnhancedTerrainAdaptation);
    }
}
