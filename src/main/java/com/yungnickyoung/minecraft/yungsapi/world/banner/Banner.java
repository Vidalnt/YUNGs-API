...
public class Banner {
    ...
    public Banner(
        List<ColoredBannerPattern> patterns,
        BlockState state,
        CompoundTag nbt
    ) {
    ...
    public static class Builder {
        ...
        private CompoundTag createBannerNBT() {
            ...
            patterns.forEach(pattern -> {
                ...
                patternNBT.putString(
                    "pattern",
                    pattern.getPattern().identifier().toString()
                );
            ...
            if (this.customColor != null || this.customNameTranslate != null) {
                String color =
                    this.customColor == null
                        ? ""
                        : String.format("\"color\":\"%s\"", this.customColor);
                String name =
                    this.customNameTranslate == null
                        ? ""
                        : String.format(
                              "\"translate\":\"%s\"",
                              this.customNameTranslate
                          );
                if (
                    this.customColor != null && this.customNameTranslate != null
                ) name = "," + name;
