...
public class MobSpawnerData {
    ...
    public CompoundTag save(CompoundTag compoundTag) {
        ...
        compoundTag.putShort(
            "RequiredPlayerRange",
            (short) this.requiredPlayerRange
        );
        compoundTag.putShort("SpawnRange", (short) this.spawnRange);
        compoundTag.put(
            "SpawnData",
            SpawnData.CODEC.encodeStart(NbtOps.INSTANCE, this.nextSpawnData)
                .result()
                .orElseThrow(() ->
        ...
        compoundTag.put(
            "SpawnPotentials",
            SpawnData.LIST_CODEC.encodeStart(
                NbtOps.INSTANCE,
    ...
    public static class Builder {
        ...
        public Builder spawnPotentials(
        ...
        public Builder setEntityType(EntityType<?> entityType) {
            this.nextSpawnData.getEntityToSpawn().putString(
                "id",
