 ...
 */
@Deprecated
public class MaxCountLegacySinglePoolElement
    extends LegacySinglePoolElement
    implements IMaxCountJigsawPoolElement
{

    public static final MapCodec<MaxCountLegacySinglePoolElement> CODEC =
            ...
            builder
                .group(
                    ...
                    Codec.STRING.fieldOf("name").forGetter(
                        MaxCountLegacySinglePoolElement::getName
                    ),
                    Codec.INT.fieldOf("max_count").forGetter(
                        MaxCountLegacySinglePoolElement::getMaxCount
                    )
                )
    ...
    public MaxCountLegacySinglePoolElement(
        Either<Identifier, StructureTemplate> Identifier,
