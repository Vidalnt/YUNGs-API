...
public class YungJigsawFeatureElement extends YungJigsawPoolElement {
    ...
    public static final MapCodec<YungJigsawFeatureElement> CODEC =
        RecordCodecBuilder.mapCodec(builder ->
            builder
                .group(
                    PlacedFeature.CODEC.fieldOf("feature").forGetter(element ->
                        element.feature
                    ),
                    projectionCodec(),
                    nameCodec(),
    ...
    private CompoundTag fillDefaultJigsawNBT() {
        ...
        $$0.putString(
            "joint",
            JigsawBlockEntity.JointType.ROLLABLE.getSerializedName()
        );
        return $$0;
    }
