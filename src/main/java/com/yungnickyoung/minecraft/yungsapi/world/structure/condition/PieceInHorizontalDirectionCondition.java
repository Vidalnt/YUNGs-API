...
public class PieceInHorizontalDirectionCondition extends StructureCondition {
    ...
    public static final MapCodec<PieceInHorizontalDirectionCondition> CODEC =
        RecordCodecBuilder.mapCodec(builder ->
            builder
                .group(
                    ...
                    Codec.INT.fieldOf("range").forGetter(conditon ->
                        conditon.range
                    ),
                    Rotation.CODEC.fieldOf("rotation").forGetter(conditon ->
                        conditon.rotation
                    )
                )
    ...
    public PieceInHorizontalDirectionCondition(
    ...
    public boolean passes(StructureContext ctx) {
        ...
        if (templateManager == null) YungsApiCommon.LOGGER.error(
            "Missing required field 'structureTemplateManager' for piece_in_horizontal_direction condition!"
        );
        if (pieces == null) YungsApiCommon.LOGGER.error(
            "Missing required field 'pieces' for piece_in_horizontal_direction condition!"
        );
        if (rotation == null) YungsApiCommon.LOGGER.error(
            "Missing required field 'rotation' for piece_in_horizontal_direction condition!"
        );
